...
DBM = {
	...
	Version = "5.04",
	DisplayVersion = "First Pull Április 29.", -- the string that is shown as version
	ReleaseRevision = 1 -- the revision of the latest stable version that is available (for /dbm ver2)
}
