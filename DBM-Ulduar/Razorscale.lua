...
local timerTurret4					= mod:NewTimer(115, "timerTurret4", 48642)
local timerGrounded                 = mod:NewTimer(33, "timerGrounded")
...
function mod:OnCombatStart(delay)
	...
	if mod:IsDifficulty("heroic10") then
		...
		timerTurret1:Start(-2)
		timerTurret2:Start(-2)
	else
		warnTurretsReadySoon:Schedule(95-delay)
		warnTurretsReady:Schedule(117-delay)
		timerTurret1:Start(-2) -- 53sec
		timerTurret2:Start(-2) -- +20
		timerTurret3:Start(-2) -- +20
		timerTurret4:Start(-2) -- +20
	end
end
...
function mod:CHAT_MSG_MONSTER_YELL(msg, mob)
	if self.vb.isGrounded and (msg == L.YellAir or msg == L.YellAir2) and GetTime() - combattime > 30 then
		...
		if mod:IsDifficulty("heroic10") then -- not sure?
			...
			timerTurret2:Start(72)
			timerTurret3:Start(91)
