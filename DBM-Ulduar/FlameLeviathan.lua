...
local timerNextFlameVents = 30
if mod:IsDifficulty("heroic10") then
	timerNextFlameVents	= mod:NewNextTimer(16, 62396)
else 
	timerNextFlameVents	= mod:NewNextTimer(16, 62396) -- im leaving this split because it keeps changing every week
end
